...
The hidden production capability for improvments in Rate, Yield, and Uptime are
 broken down by Line and Product for 2019. Additional capacity is computed from
  shifting averages for each of the perofrmance metrics to upper quantiles (50%-95%).

Example: the annualized additional production capacity for p75 (opperating at
75% performance) represent 164M additional units of production; or a 7.9%
increase in production from the current opperating performance."""
                        ),
